window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function OpenAICodexSettings({ t, configScope, updater, account, embedded = false, accountOnly = false }) {
			...
			const moduleSummary = (module) => {
				...
				return t("capabilitiesModuleEnabled", { count: config === void 0 ? 0 : [
					config.enableSearch,
					config.enableReserveFallback,
					config.enableNativeCompaction,
		...
		*/
		...
		function OpenAICodexBundleConfig({ view, t, account, configScope }) {
			if (view === "summary") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_jsx_runtime.Fragment, { children: t("intro") });
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(OpenAICodexModelsCard, {
				t,
				account,
				...configScope === void 0 ? {} : { configScope }
			});
